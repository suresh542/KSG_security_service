      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            <div className="relative overflow-hidden text-dark dark:text-white  rounded-2xl">
              <img
                src={AboutImg}
          ...
          <div className="space-y-6">
            ...
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl text-dark dark:text-white font-bold leading-tight">
