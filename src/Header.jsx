      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid w-full grid-cols-[auto_1fr_auto] items-center gap-4 h-16">
          ...
          >
            {/* Toggle Circle */}
            <span
              className={`absolute top-1 h-10 w-10 rounded-full !bg-white  shadow-md transition-transform duration-300 ${isDark ? 'translate-x-12' : 'translate-x-0'
                }`}
            />
            ...
            <span className="absolute left-3 flex items-center justify-center">
              <Sun
                className={`h-5 w-5 transition-colors duration-300 ${isDark ? 'text-gray-500' : 'text-gray-900'
                  }`}
              />
            </span>
            ...
            <span className="absolute right-3 flex items-center justify-center">
              <Moon
                className={`h-5 w-5 transition-colors duration-300 ${isDark ? 'text-[#0d1b2e]' : 'text-gray-500'
                  }`}
              />
            </span>
          </button>
