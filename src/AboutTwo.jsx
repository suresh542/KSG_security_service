...
import CapabilitiesImage from './images/CapabilitiesImg.png'
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <ul className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <p className=" text-lg sm:text-base text-gray-700 dark:text-gray-100 leading-relaxed font-large">
                    {item}
                  </p>
                </li>
              ))}
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <div className="absolute -bottom-6 -left-6 lg:-left-10 stat-card rounded-xl p-4 backdrop-blur-sm">
              ...
              <div className="text-gray-700 dark:text-gray-100 text-sm font-body">Active Monitoring</div>
            </div>
          </div>
        </div>
      </div>
